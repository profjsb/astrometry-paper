...
href{}{}
%provide an explicit application to the case of bivariate normal distributions in the catalogue space of tie objects. %MCMC is used to generate a posterior estimate for the joint distribution of the transformation parameters. The use of distortion maps to represent the maximum likelihood transformation is also considered.
